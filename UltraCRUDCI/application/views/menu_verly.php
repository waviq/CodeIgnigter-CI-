...
foreach ($list_siswa->result() as $verlishow) {
?>
<tr>
<td><?= $i++ ?></td>
<td><?= $verlishow->nama_siswa?></td>
<td>
<?= $verlishow->alamat_siswa ?></td>
<td>
<a href="<?= base_url() ?>index.php/verlicontroller/updatesiswa/<?= $verlishow->id_siswa ?>"<span class="badge bg-blue">Ubah</span></a>
<a href="<?= base_url() ?>index.php/verlicontroller/deletesiswa/<?= $verlishow->id_siswa ?>"<span class="badge bg-red">Hapus</span></td>
</tr>
    <?php
    }
    ?>
...
<!-- form start -->
<form method="post" action="<?= base_url() ?>index.php/verlicontroller/addsiswa" role="form">
<div class="box-body">
