<?php
echo form_open('index.php/control_verli_login/cek_login')
?>
<!DOCTYPE html>
<html class="bg-black">
    <head>
        <meta charset="UTF-8">
        <title>Login Aplikasi CRUD CI</title>
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
       <!--INCLUDE VERLIBOOTSTRAP-->
    ...
    <body class="bg-black">
<center><h1>APLIKASI CRUD DENGAN CODEIGNITER</h1></center>
<center><small>By.VerlyAnanda From Ultraviolet Developer</small></center>
